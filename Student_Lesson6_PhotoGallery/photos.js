...
for (var i = 1; i < 4; i++){
    ...
    currentFig = document.getElementByTagName("img")[i - 1];
...
//declare varible for document element with id of leftarrow, which is in the html document 
var leftarrow= document.getElementById("leftarrow");

//add an event handler to the specified document element (leftarrow)
//leftArrow() function will be executed when the user clicks the left navigation arrow button
leftarrow.addEventListener("click",leftArrow, false);

//declare variable for document element with id of rightarrow in the html document 
var rightarrow= document.getElementById("rightarrow");
//add an event handler to the specified documentelement (rightarrow)
